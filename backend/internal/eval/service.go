...
func ExecuteCenterRun(opts CenterRunOptions) (CenterRunBundle, error) {
	...
	run := ReportRun{
		...
		Params: map[string]any{
			...
			"denseTopK":     opts.Retrieval.DenseTopK,
			"lexicalTopK":   opts.Retrieval.LexicalTopK,
			"fusionTopK":    opts.Retrieval.FusionTopK,
			"rerankTopN":    opts.Retrieval.RerankTopN,
			"denseWeight":   opts.Retrieval.DenseWeight,
			"lexicalWeight": opts.Retrieval.LexicalWeight,
			"lexicalMode":   opts.Retrieval.LexicalMode,
			"rerankMode":    opts.Retrieval.RerankMode,
